...
export function resolveCanonicalPaymentState(order = {}) {
...
export function deriveUiState(status = 'awaiting_payment', technicalState = 'syncing', stale = false) {
...
export function reconcilePaymentState(order, paymentData = {}) {
  const current = order || {};
...
export function getOrderState(orderId, { store } = {}) {
