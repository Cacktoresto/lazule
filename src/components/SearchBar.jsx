  ...
  return (
    <form className="w-full" role="search" aria-label="Refinar fragrâncias no catálogo" onSubmit={handleSubmit}>
      <label className="block w-full" htmlFor="catalog-search">
        ...
        <input
          id="catalog-search"
          className="laz-breathe min-h-12 w-full rounded-2xl border border-[var(--laz-border-mineral)] bg-[#0f1b35b8] px-4 py-3 text-[16px] text-[var(--laz-text-main)] outline-none ring-0 placeholder:text-[var(--laz-text-muted)] transition duration-300 hover:border-[#95b4ec66] focus-visible:border-[#8fb3ffcc] focus-visible:bg-[#122445d6] focus-visible:ring-2 focus-visible:ring-[#5a8eff8a] focus-visible:ring-offset-2 focus-visible:ring-offset-[#070d1d] sm:rounded-full sm:py-3.5 sm:text-base"
          type="search"
          value={value}
      ...
      <div className="mt-3 grid gap-3 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:shrink-0">
          ...
          <button
            className="lazule-premium-button lazule-cta-shimmer min-h-11 rounded-full border border-[#2c58a8] bg-gradient-to-r from-[#17356a] via-[#214886] to-[#193b73] px-5 text-sm font-semibold text-[#ecf2ff] shadow-mineral hover:border-[#b79249aa] hover:text-[#f8f2e4]"
            type="submit"
          >
