  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-lazule-night/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
        <a href="/" className="group flex items-center gap-3" aria-label="LAZULE FRAGRANCES">
        ...
        <nav className="hidden items-center gap-8 text-sm text-slate-300 md:flex">
          <a className="transition hover:text-lazule-gold" href="/">
            Início
          </a>
          <a className="transition hover:text-lazule-gold" href="/catalogo">
            Catálogo
          </a>
          <a className="transition hover:text-lazule-gold" href="/faq">
            Como funciona
          </a>
        </nav>
