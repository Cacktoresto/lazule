...
const drawerSurfaceClass = [
  'fixed right-0 top-0 flex h-screen w-screen max-w-full flex-col overflow-hidden border-l border-lazule-gold/[0.18]',
  ...
  'transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] sm:w-[min(460px,100vw)] sm:rounded-l-[2.35rem]',
].join(' ');
...
const footerClass = [
  'sticky bottom-0 z-20 shrink-0 border-t border-white/[0.1] pt-4',
    ...
    <div className={`${drawerRootClass} ${open ? 'pointer-events-auto' : ''}`} aria-hidden={!open}>
      ...
      >
        ...
        <div className="relative z-10 flex h-full min-h-0 flex-col">
          <div className="sticky top-0 z-20 shrink-0 border-b border-white/[0.075] bg-[linear-gradient(180deg,rgba(3,7,19,0.99),rgba(3,7,19,0.94))] pb-4 pt-1 backdrop-blur-md">
          ...
          <div className="min-h-0 flex-1 space-y-3 overflow-y-auto py-3 pr-1 [scrollbar-width:thin] [scrollbar-color:rgba(200,162,77,0.45)_transparent]">
