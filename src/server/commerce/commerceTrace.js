function createCommerceTrace({ operation = 'commerce', correlationId = null, orderId = null, paymentId = null, checkoutSessionId = null, source = 'system' } = {}) {
  const trace = {
...
module.exports = { createCommerceTrace };
